...
procedure TKATs
is
   FN : constant String := "../../KAT/MLKEM/kat_MLKEM_768.rsp";
   FH : File_Type;
   ...
   type MLKEM_KAT is record
      ...
      --  Expected CT and SS for failure case
      Expected_CT_N  : Ciphertext;
      Expected_SS_N  : Bytes_32;
   ...
   Null_MLKEM_KAT : constant MLKEM_KAT :=
     (Count        => 0,
      ...
      Expected_CT_N  => (others => 0),
      Expected_SS_N  => Null_Bytes_32,
   ...
   begin
      ...
      if EK_Valid_For_Encaps (CK.EK) then
         ...
         if TK.Expected_SS_N /= TK.Computed_SS_N then
            Put_Line ("Expected_SS_N = Computed_SS_N Fail");
         end if;
