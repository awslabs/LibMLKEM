...
Intel x86_64 running Ubuntu 20.04.6 LTS. Your mileage on
...
### Linux (Ubuntu 20.04.6 LTS or similar)

[Alire tool](https://alire.ada.dev/)

[GCC 13.1.0](https://github.com/alire-project/GNAT-FSF-builds/releases/tag/gnat-13.1.0-1)

[GPRBUILD](https://github.com/alire-project/GNAT-FSF-builds/releases/tag/gprbuild-22.0.0-1)

[SPARK Toolset 12.1.0](https://github.com/alire-project/GNAT-FSF-builds/releases/tag/gnatprove-12.1.0-1)

Note 1: GPRBUILD ships as a separate package on Linux, so you need to install it.

Note 2: These compilers don't seem to work on Amazon Linux 2, owing to some incompatibility with GLibc.

You need to add these tools to your PATH environment variable as appropriate.
